...
if __name__ == '__main__':
    ...
    perBuildingDir = 'C:/Users/enoch/Documents/GitHub/caltech-twin/digitaltwin/buildings_aggregated/'
    ...
    for b in buildings:
        ...
        for key in aggregateValues.keys():
            saveFilename = saveDir + b + '_' + key + '.csv'
            timestampKey = key.split('_')[0] + '_timestamps'

            with open(saveFilename, 'w') as out:
                csv_out = csv.writer(out)
                csv_out.writerow(['t', 'v'])
                for t, v in zip(aggregateTimestamps[timestampKey], aggregateValues[key]):
                    csv_out.writerow([t,v])
